      ...
      (function generateTemplate() {
        ...
        try {
          (function buildUpConvertCriteria() {
            ...
            // Not sur to use `childInstructions` or `parentInstructions`. `childInstructions` seems to be more userfreindly
            // Other statements contains schemaName from parent. 
            // To verify next time /!\ 
            if (childInstructions.meta && childInstructions.meta.schemaName) {
              convertObj.opts = {
                schema: childInstructions.meta.schemaName
              };
            }
      ...
      (function generateTemplate() {
        ...
        try {
          (function buildUpConvertCriteria() {
            ...
            // Not sur to use `parentInstructions` or `parentInstructions`. `parentInstructions` seems to be more userfreindly
            if (childInstructions.meta && childInstructions.meta.schemaName) {
              convertObj.opts = {
                schema: parentInstructions.meta.schemaName
              };
            }
